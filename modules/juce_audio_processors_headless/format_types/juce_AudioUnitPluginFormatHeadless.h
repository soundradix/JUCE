...
/**
    ...
    @tags{Audio}
*/
class JUCE_API  AudioUnitPluginFormatHeadless   : public AudioPluginFormat
{
public:
    //==============================================================================
    AudioUnitPluginFormatHeadless() = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioUnitPluginFormatHeadless)
};
